...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  void sellProduct() {
    if (_addProductFormKey.currentState != null && _addProductFormKey.currentState!.validate() && images.isNotEmpty) {
      ...
      print(_addProductFormKey.currentState);
